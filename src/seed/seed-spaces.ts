...
async function seedSpaces() {
  ...
  try {
    ...
    // Get brands to assign spaces to
    ...
    const sampleSpaces = [
      // CHENNAI SPACES
      {
        ...
        brand: (brands.brands[0] as any)._id,
      ...
      },
      {
        ...
        brand: brands.brands[1] ? (brands.brands[1] as any)._id : (brands.brands[0] as any)._id,
      ...
      },
      {
        ...
        brand: brands.brands[2] ? (brands.brands[2] as any)._id : (brands.brands[0] as any)._id,
